...
# Locate all boundary facets (for Dirichlet BCs on the entire boundary)
...
# Define Dirichlet BC (u = 0 on all boundaries)
...
L = inner(f, v) * dx  # Neumann term removed
...
with io.XDMFFile(msh.comm, "out_poisson_dirichlet/poisson.xdmf", "w") as file:
    file.write_mesh(msh)
...
try:
    ...
    if pyvista.OFF_SCREEN:
        ...
        plotter.screenshot("uh_poisson_dirichlet.png")
    else:
        plotter.show()
