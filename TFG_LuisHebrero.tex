...
\begin{mdframed}
    \begin{exmp}
        ...
        \begin{equation}\label{eq:1dCoeff}
            ...
            \right.
        \end{equation}
        Claramente, no existe una solución fuerte, porque $u$ tiene que ser derivable, y en tal caso, la parte izquierda de la ecuación no podría ser igual a una función discontinua. \colorbox{yellow}{NO SE SI ESTE ES EL MOTIVO}Sin embargo la solución débil $u\in H^1((-1,1))$ para esta ecuación es
