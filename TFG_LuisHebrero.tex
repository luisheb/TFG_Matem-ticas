...
\begin{defin}
    ...
    \end{equation}
    En ambas definiciones las derivadas parciales se entienden en sentido débil, es decir
\end{defin}
\end{mdframed}
...
\begin{dem}
    ...
    \begin{itemize}
        ...
        \end{align}
        donde $c_0 = \tilde{c}/(1 + c_{\star})$, y por lo tanto demostrando (a).
    \end{itemize}
...
\end{equation*}
Como hemos visto en la sección \ref{sec:EDPs}, esta ecuación tiene solución única en $H_0^1(\Omega)$ si se cumple la condición de \eqref{eq:condiciones_LaxMilgram_extra}. De este modo, para que la formulación del problema sea válida, asumiremos que se cumple esta condición.
