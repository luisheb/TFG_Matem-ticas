...
\begin{mdframed}
    \begin{exmp}
        ...
        En esta gráfica, \colorbox{yellow}{HAY QUE EXPLICAR QUE SIGNIFICA CADA UNA DE LAS LINEAS GRAFICADAS}
...
\section{El problema elíptico autoadjunto}\label{sec:ProblemaAutoadjunto}
...
\begin{equation*}
    a(u,\varphi) = l(\varphi) \quad \forall \varphi\in  H_0^1(\Omega).
\end{equation*}
Donde, al tratarse de un problema autoadjunto,  $a(u,\varphi)$ y $l(\varphi)$ son los siguientes funcionales
\begin{equation*}
    a(u,\varphi) = \int_{\Omega} \sum_{i,j=1}^{n} a_{ij}(\mathbf{x})\frac{\partial u}{\partial x_i}\frac{\partial \varphi}{\partial x_j} + c(\mathbf{x})u\varphi \, d\mathbf{x}, \quad l(\varphi) = \int_{\Omega} f\varphi \, d\mathbf{x}.
\end{equation*}
