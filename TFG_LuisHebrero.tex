...
Para simplificar esta engorrosísima notación, nos interesa definir la siguiente forma bilineal
...
\begin{defin}
    ...
    \end{align*}
    Y además, cumple la siguiente propiedad de simetría, es decir, que los coeficientes $a_{ij}$ son simétricos, 
...
\begin{equation}
    J(u) = \frac{1}{2}a(u,v) - l(v), \quad v\in H_0^1(\Omega)
\end{equation}
